...
from backend.config.database import get_auth_data
from backend.src.scripts.passwords import verify_password
from backend.src.scripts.sql_scripts import get_user_by_login, get_user_by_uid

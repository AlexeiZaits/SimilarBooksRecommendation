...
from backend.search_service.src.exceptions.custom_exceptions import RedisDataNotFoundException
from backend.search_service.src.schemas.tamplates_app import RedisResponse

...
from backend.auth_service.src.models.models import get_db_connection
from backend.auth_service.src.schemas.templates_auth import UserAuth, UserRegister
from backend.auth_service.src.scripts.auth import authenticate_user, get_current_admin_user, get_current_user, get_token
from backend.auth_service.src.scripts.passwords import create_access_token, get_password_hash
from backend.auth_service.src.scripts.sql_scripts import create_user, get_user_by_login
